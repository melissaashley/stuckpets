...
function returnResults(param) {
  ...
  if ('names' === appendType) {
    ...
    var number = appendType === 'random' ? '10000' : '100000';
    ...
    var _numbersArray = Array.from({
      length: numberCount
    }, function (v, k) {
      return k + selectVal;
    });

    generatedArray = _numbersArray;
  }
  ...
  try {
    for (var _iterator = generatedArray[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var eachItem = _step.value;
      var item = "<a href=\"http://neopets.com/~".concat(param).concat(eachItem, "\" target=\"_blank\"><img src=\"http://pets.neopets.com/cpn/").concat(param).concat(eachItem, "/1/1.png\"></a>");
